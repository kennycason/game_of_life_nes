...
void effect_flush_wait(void) {
    ...
    if (wait_x >= 0) effect_add(wait_x + 1);
...
static inline void mem_wr(int adr, unsigned char data) {
    ...
    if (adr < 0x4018)//APU registers
    {
        ...
        if (adr == 0x4000 || adr == 0x4002 || adr == 0x4003 || adr == 0x4004 || adr == 0x4006 || adr == 0x4007 ||
            adr == 0x4008 || adr == 0x400a || adr == 0x400b || adr == 0x400c ||
